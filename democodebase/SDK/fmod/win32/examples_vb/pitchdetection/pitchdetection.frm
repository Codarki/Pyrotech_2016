...
Private Sub Form_Load()
    ...
    For count = 0 To numdrivers - 1
        result = FMOD_System_GetDriverName(system, count, name(0), 128)
        ERRCHECK (result)
    ...
    For count = 0 To numdrivers - 1
        result = FMOD_System_GetRecordDriverName(system, count, name(0), 128)
        ERRCHECK (result)
...
Private Sub ComboRecord_Click()
    ...
    result = FMOD_System_GetSoftwareFormat(system, outputfreq, format, 0, 0, 0)
    ERRCHECK (result)
