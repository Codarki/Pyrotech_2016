...
' ============================================================================================ '
' FMOD Ex - Visual Basic Module.    Copyright (c), Firelight Technologies Pty, Ltd. 2004-2006. '
'                                                                                              '
'                                                                                              '
' ============================================================================================ '
...
Public Const FMOD_VERSION As Long = &H40619
...
Public Enum FMOD_CAPS
    ...
    FMOD_CAPS_HARDWARE_EMULATED = &H2                ' Device supports FMOD_HARDWARE but it will be mixed on the CPU by the kernel (not FMOD's software mixer).
...
'[
    ...
    '[PLATFORMS]
    'Win32, Win64, Macintosh, XBox, XBox360, PlayStation 2
...
Public Declare Function FMOD_System_GetDriverName Lib "fmodexp.dll" (ByVal system As Long, ByVal Id As Long, ByRef name As Byte, ByVal Namelen As Long) As FMOD_RESULT
...
Public Declare Function FMOD_System_LoadPlugin Lib "fmodexp.dll" (ByVal system As Long, ByVal Filename As String, ByRef Plugintype As FMOD_PLUGINTYPE, ByRef Index As Long) As FMOD_RESULT
...
Public Declare Function FMOD_System_GetPluginInfo Lib "fmodexp.dll" (ByVal system As Long, ByVal Plugintype As FMOD_PLUGINTYPE, ByVal Index As Long, ByRef name As Byte, ByVal Namelen As Long, ByRef version As Long) As FMOD_RESULT
Public Declare Function FMOD_System_UnloadPlugin Lib "fmodexp.dll" (ByVal system As Long, ByVal Plugintype As FMOD_PLUGINTYPE, ByRef Index As Long) As FMOD_RESULT
Public Declare Function FMOD_System_SetOutputByPlugin Lib "fmodexp.dll" (ByVal system As Long, ByVal Index As Long) As FMOD_RESULT
Public Declare Function FMOD_System_GetOutputByPlugin Lib "fmodexp.dll" (ByVal system As Long, ByRef Index As Long) As FMOD_RESULT
...
Public Declare Function FMOD_System_UpdateFinished Lib "fmodexp.dll" (ByVal system As Long) As FMOD_RESULT
...
Public Declare Function FMOD_System_SetSpeakerPosition Lib "fmodexp.dll" (ByVal system As Long, ByVal Speaker As FMOD_SPEAKER, ByVal X As Single, ByVal Y As Single) As FMOD_RESULT
Public Declare Function FMOD_System_GetSpeakerPosition Lib "fmodexp.dll" (ByVal system As Long, ByRef Speaker As FMOD_SPEAKER, ByRef X As Single, ByRef Y As Single) As FMOD_RESULT
...
Public Declare Function FMOD_System_AddDSP Lib "fmodexp.dll" (ByVal system As Long, ByVal Dsp As Long) As FMOD_RESULT
...
Public Declare Function FMOD_System_SetRecordDriver Lib "fmodexp.dll" (ByVal system As Long, ByVal Driver As Long) As FMOD_RESULT
Public Declare Function FMOD_System_GetRecordDriver Lib "fmodexp.dll" (ByVal system As Long, ByRef Driver As Long) As FMOD_RESULT
...
Public Declare Function FMOD_System_GetRecordDriverName Lib "fmodexp.dll" (ByVal system As Long, ByVal Id As Long, ByRef name As Byte, ByVal Namelen As Long) As FMOD_RESULT
Public Declare Function FMOD_System_GetRecordPosition Lib "fmodexp.dll" (ByVal system As Long, ByRef Position As Long) As FMOD_RESULT

Public Declare Function FMOD_System_RecordStart Lib "fmodexp.dll" (ByVal system As Long, ByVal Sound As Long, ByVal Loop_ As Long) As FMOD_RESULT
Public Declare Function FMOD_System_RecordStop Lib "fmodexp.dll" (ByVal system As Long) As FMOD_RESULT
Public Declare Function FMOD_System_IsRecording Lib "fmodexp.dll" (ByVal system As Long, ByRef Recording As Long) As FMOD_RESULT
...
Public Declare Function FMOD_Channel_SetCallback Lib "fmodexp.dll" (ByVal channel As Long, ByVal Type_ As FMOD_CHANNEL_CALLBACKTYPE, ByVal Callback As Long, ByVal Command As Long) As FMOD_RESULT
...
Public Declare Function FMOD_Channel_AddDSP Lib "fmodexp.dll" (ByVal channel As Long, ByVal Dsp As Long) As FMOD_RESULT
...
Public Declare Function FMOD_ChannelGroup_OverridePaused Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByVal paused As Long) As FMOD_RESULT
...
Public Declare Function FMOD_ChannelGroup_OverrideMute Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByVal Mute As Long) As FMOD_RESULT
...
Public Declare Function FMOD_ChannelGroup_AddDSP Lib "fmodexp.dll" (ByVal Channelgroup As Long, ByVal Dsp As Long) As FMOD_RESULT
...
Public Declare Function FMOD_DSP_AddInput Lib "fmodexp.dll" (ByVal Dsp As Long, ByVal Target As Long) As FMOD_RESULT
...
Public Declare Function FMOD_DSP_GetInput Lib "fmodexp.dll" (ByVal Dsp As Long, ByVal Index As Long, ByRef Input_ As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_GetOutput Lib "fmodexp.dll" (ByVal Dsp As Long, ByVal Index As Long, ByRef Output As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_SetInputMix Lib "fmodexp.dll" (ByVal Dsp As Long, ByVal Index As Long, ByVal Volume As Single) As FMOD_RESULT
Public Declare Function FMOD_DSP_GetInputMix Lib "fmodexp.dll" (ByVal Dsp As Long, ByVal Index As Long, ByVal Volume As Single) As FMOD_RESULT
Public Declare Function FMOD_DSP_SetInputLevels Lib "fmodexp.dll" (ByVal Dsp As Long, ByVal Index As Long, ByVal Speaker As FMOD_SPEAKER, ByRef Levels As Single, ByVal Numlevels As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_GetInputLevels Lib "fmodexp.dll" (ByVal Dsp As Long, ByVal Index As Long, ByVal Speaker As FMOD_SPEAKER, ByRef Levels As Single, ByVal Numlevels As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_SetOutputMix Lib "fmodexp.dll" (ByVal Dsp As Long, ByVal Index As Long, ByVal Volume As Single) As FMOD_RESULT
Public Declare Function FMOD_DSP_GetOutputMix Lib "fmodexp.dll" (ByVal Dsp As Long, ByVal Index As Long, ByVal Volume As Single) As FMOD_RESULT
Public Declare Function FMOD_DSP_SetOutputLevels Lib "fmodexp.dll" (ByVal Dsp As Long, ByVal Index As Long, ByVal Speaker As FMOD_SPEAKER, ByRef Levels As Single, ByVal Numlevels As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_GetOutputLevels Lib "fmodexp.dll" (ByVal Dsp As Long, ByVal Index As Long, ByVal Speaker As FMOD_SPEAKER, ByRef Levels As Single, ByVal Numlevels As Long) As FMOD_RESULT
