...
namespace dsp_effectperspeaker
{
	public class Form1 : System.Windows.Forms.Form
	{
        ...
        private FMOD.DSP        dspreverb = null, dspchorus = null;
        ...
        private void Form1_Load(object sender, System.EventArgs e)
        {
            ...
            */  
            ...
            result = dsphead.getInput(0, ref dspchannelmixer);
            ERRCHECK(result);
            ...
            */
        {
            ...
            result = dsphead.setInputLevels(0, FMOD.SPEAKER.FRONT_LEFT, leftinputon, 2);
            ERRCHECK(result);
            result = dsphead.setInputLevels(0, FMOD.SPEAKER.FRONT_RIGHT, inputsoff, 2);
            ERRCHECK(result);

            result = dsphead.setInputLevels(1, FMOD.SPEAKER.FRONT_LEFT, inputsoff, 2);
            ERRCHECK(result);
            result = dsphead.setInputLevels(1, FMOD.SPEAKER.FRONT_RIGHT, rightinputon, 2);
            ERRCHECK(result);
        }
