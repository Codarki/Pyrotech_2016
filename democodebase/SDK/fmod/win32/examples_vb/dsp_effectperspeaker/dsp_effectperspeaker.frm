...
Private Sub Form_Load()
    ...
    result = FMOD_DSP_SetInputLevels(dsphead, 0, FMOD_SPEAKER_FRONT_LEFT, leftinputon(0), 2)
    ERRCHECK (result)
    result = FMOD_DSP_SetInputLevels(dsphead, 0, FMOD_SPEAKER_FRONT_RIGHT, inputsoff(0), 2)
    ERRCHECK (result)

    result = FMOD_DSP_SetInputLevels(dsphead, 1, FMOD_SPEAKER_FRONT_LEFT, inputsoff(0), 2)
    ERRCHECK (result)
    result = FMOD_DSP_SetInputLevels(dsphead, 1, FMOD_SPEAKER_FRONT_RIGHT, rightinputon(0), 2)
    ERRCHECK (result)
