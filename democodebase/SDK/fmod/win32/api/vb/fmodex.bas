...
Public Declare Function FMOD_System_GetDriverName Lib "fmodex.dll" (ByVal system As Long, ByVal Id As Long, ByRef name As Byte, ByVal Namelen As Long) As FMOD_RESULT
...
Public Declare Function FMOD_System_LoadPlugin Lib "fmodex.dll" (ByVal system As Long, ByVal Filename As String, ByRef Plugintype As FMOD_PLUGINTYPE, ByRef Index As Long) As FMOD_RESULT
...
Public Declare Function FMOD_System_GetPluginInfo Lib "fmodex.dll" (ByVal system As Long, ByVal Plugintype As FMOD_PLUGINTYPE, ByVal Index As Long, ByRef name As Byte, ByVal Namelen As Long, ByRef version As Long) As FMOD_RESULT
Public Declare Function FMOD_System_UnloadPlugin Lib "fmodex.dll" (ByVal system As Long, ByVal Plugintype As FMOD_PLUGINTYPE, ByRef Index As Long) As FMOD_RESULT
Public Declare Function FMOD_System_SetOutputByPlugin Lib "fmodex.dll" (ByVal system As Long, ByVal Index As Long) As FMOD_RESULT
Public Declare Function FMOD_System_GetOutputByPlugin Lib "fmodex.dll" (ByVal system As Long, ByRef Index As Long) As FMOD_RESULT
...
Public Declare Function FMOD_System_UpdateFinished Lib "fmodex.dll" (ByVal system As Long) As FMOD_RESULT
...
Public Declare Function FMOD_System_SetSpeakerPosition Lib "fmodex.dll" (ByVal system As Long, ByVal Speaker As FMOD_SPEAKER, ByVal X As Single, ByVal Y As Single) As FMOD_RESULT
Public Declare Function FMOD_System_GetSpeakerPosition Lib "fmodex.dll" (ByVal system As Long, ByRef Speaker As FMOD_SPEAKER, ByRef X As Single, ByRef Y As Single) As FMOD_RESULT
...
Public Declare Function FMOD_System_AddDSP Lib "fmodex.dll" (ByVal system As Long, ByVal Dsp As Long) As FMOD_RESULT
...
Public Declare Function FMOD_System_SetRecordDriver Lib "fmodex.dll" (ByVal system As Long, ByVal Driver As Long) As FMOD_RESULT
Public Declare Function FMOD_System_GetRecordDriver Lib "fmodex.dll" (ByVal system As Long, ByRef Driver As Long) As FMOD_RESULT
...
Public Declare Function FMOD_System_GetRecordDriverName Lib "fmodex.dll" (ByVal system As Long, ByVal Id As Long, ByRef name As Byte, ByVal Namelen As Long) As FMOD_RESULT
Public Declare Function FMOD_System_GetRecordPosition Lib "fmodex.dll" (ByVal system As Long, ByRef Position As Long) As FMOD_RESULT

Public Declare Function FMOD_System_RecordStart Lib "fmodex.dll" (ByVal system As Long, ByVal Sound As Long, ByVal Loop_ As Long) As FMOD_RESULT
Public Declare Function FMOD_System_RecordStop Lib "fmodex.dll" (ByVal system As Long) As FMOD_RESULT
Public Declare Function FMOD_System_IsRecording Lib "fmodex.dll" (ByVal system As Long, ByRef Recording As Long) As FMOD_RESULT
...
Public Declare Function FMOD_Channel_SetCallback Lib "fmodex.dll" (ByVal channel As Long, ByVal Type_ As FMOD_CHANNEL_CALLBACKTYPE, ByVal Callback As Long, ByVal Command As Long) As FMOD_RESULT
...
Public Declare Function FMOD_Channel_AddDSP Lib "fmodex.dll" (ByVal channel As Long, ByVal Dsp As Long) As FMOD_RESULT
...
Public Declare Function FMOD_ChannelGroup_OverridePaused Lib "fmodex.dll" (ByVal Channelgroup As Long, ByVal paused As Long) As FMOD_RESULT
...
Public Declare Function FMOD_ChannelGroup_OverrideMute Lib "fmodex.dll" (ByVal Channelgroup As Long, ByVal Mute As Long) As FMOD_RESULT
...
Public Declare Function FMOD_ChannelGroup_AddDSP Lib "fmodex.dll" (ByVal Channelgroup As Long, ByVal Dsp As Long) As FMOD_RESULT
...
Public Declare Function FMOD_DSP_AddInput Lib "fmodex.dll" (ByVal Dsp As Long, ByVal Target As Long) As FMOD_RESULT
...
Public Declare Function FMOD_DSP_GetInput Lib "fmodex.dll" (ByVal Dsp As Long, ByVal Index As Long, ByRef Input_ As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_GetOutput Lib "fmodex.dll" (ByVal Dsp As Long, ByVal Index As Long, ByRef Output As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_SetInputMix Lib "fmodex.dll" (ByVal Dsp As Long, ByVal Index As Long, ByVal Volume As Single) As FMOD_RESULT
Public Declare Function FMOD_DSP_GetInputMix Lib "fmodex.dll" (ByVal Dsp As Long, ByVal Index As Long, ByVal Volume As Single) As FMOD_RESULT
Public Declare Function FMOD_DSP_SetInputLevels Lib "fmodex.dll" (ByVal Dsp As Long, ByVal Index As Long, ByVal Speaker As FMOD_SPEAKER, ByRef Levels As Single, ByVal Numlevels As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_GetInputLevels Lib "fmodex.dll" (ByVal Dsp As Long, ByVal Index As Long, ByVal Speaker As FMOD_SPEAKER, ByRef Levels As Single, ByVal Numlevels As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_SetOutputMix Lib "fmodex.dll" (ByVal Dsp As Long, ByVal Index As Long, ByVal Volume As Single) As FMOD_RESULT
Public Declare Function FMOD_DSP_GetOutputMix Lib "fmodex.dll" (ByVal Dsp As Long, ByVal Index As Long, ByVal Volume As Single) As FMOD_RESULT
Public Declare Function FMOD_DSP_SetOutputLevels Lib "fmodex.dll" (ByVal Dsp As Long, ByVal Index As Long, ByVal Speaker As FMOD_SPEAKER, ByRef Levels As Single, ByVal Numlevels As Long) As FMOD_RESULT
Public Declare Function FMOD_DSP_GetOutputLevels Lib "fmodex.dll" (ByVal Dsp As Long, ByVal Index As Long, ByVal Speaker As FMOD_SPEAKER, ByRef Levels As Single, ByVal Numlevels As Long) As FMOD_RESULT
