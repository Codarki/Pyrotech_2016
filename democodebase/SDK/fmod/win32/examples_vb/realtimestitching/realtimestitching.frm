...
Private Sub Form_Load()
    ...
    result = FMOD_System_CreateStream(system, soundname(0), FMOD_NORMAL, subsound(0))
    ERRCHECK (result)

    result = FMOD_System_CreateStream(system, soundname(0), FMOD_NORMAL, subsound(1))
    ERRCHECK (result)
...
Private Sub Timer_Timer()
    ...
    If channel Then
        ...
        If currentsubsoundid <> subsoundid Then
            ...
            result = FMOD_System_CreateStream(system, soundname(sentenceid), FMOD_NORMAL, subsound(subsoundid))
            ERRCHECK (result)
