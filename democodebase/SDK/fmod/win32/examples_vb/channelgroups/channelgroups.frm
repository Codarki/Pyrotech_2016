...
Private Sub cmdMuteA_Click()
    ...
    result = FMOD_ChannelGroup_OverrideMute(groupA, muteA)
...
Private Sub cmdMuteB_Click()
    ...
    result = FMOD_ChannelGroup_OverrideMute(groupB, muteB)
...
Private Sub cmdMuteMaster_Click()
    ...
    result = FMOD_ChannelGroup_OverrideMute(masterGroup, mutemaster)
