...
Private Sub chkChorus_Click()
    ...
    If active Then
        ...
        ERRCHECK (result)
    Else
        result = FMOD_System_AddDSP(system, dspchorus)
        ERRCHECK (result)
    End If
End Sub
...
Private Sub chkDistortion_Click()
    ...
    If active Then
        ...
        ERRCHECK (result)
    Else
        result = FMOD_System_AddDSP(system, dspdistortion)
        ERRCHECK (result)
    End If
End Sub
...
Private Sub chkEcho_Click()
    ...
    If active Then
        ...
        ERRCHECK (result)
    Else
        result = FMOD_System_AddDSP(system, dspecho)
        ERRCHECK (result)
    End If
End Sub
...
Private Sub chkFlange_Click()
    ...
    If active Then
        ...
        ERRCHECK (result)
    Else
        result = FMOD_System_AddDSP(system, dspflange)
        ERRCHECK (result)
    End If
End Sub
...
Private Sub chkHighPass_Click()
    ...
    If active Then
        ...
        ERRCHECK (result)
    Else
        result = FMOD_System_AddDSP(system, dsphighpass)
        ERRCHECK (result)
    End If
End Sub
...
Private Sub chkLowPass_Click()
    ...
    If active Then
        ...
        ERRCHECK (result)
    Else
        result = FMOD_System_AddDSP(system, dsplowpass)
        ERRCHECK (result)
    End If
End Sub
...
Private Sub chkParameq_Click()
    ...
    If active Then
        ...
        ERRCHECK (result)
    Else
        result = FMOD_System_AddDSP(system, dspparameq)
        ERRCHECK (result)
    End If
End Sub
