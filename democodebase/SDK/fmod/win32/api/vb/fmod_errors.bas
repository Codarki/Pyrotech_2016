...
' =============================================================================================== '
' FMOD Ex - Error Visual Basic Module. Copyright (c), Firelight Technologies Pty, Ltd. 2004-2005. '
'                                                                                                 '
...
Public Function FMOD_ErrorString(errcode As FMOD_RESULT) As String
    Select Case errcode
        ...
        Case Is = FMOD_ERR_INTERNAL:               FMOD_ErrorString = "An error occured that wasnt supposed to.  Contact support. "
        ...
        Case Is = FMOD_ERR_PLUGIN:                 FMOD_ErrorString = "An unspecified error has been  = ed from a 3rd party plugin. "
        ...
        Case Is = FMOD_ERR_UPDATE:                 FMOD_ErrorString = "On PS2, System::update was called twice in a row when System::updateFinished must be called first. "
        Case Is = FMOD_ERR_VERSION:                FMOD_ErrorString = "The version number of this file format is not supported. "
        Case Is = FMOD_ERR_EVENT_FAILED:           FMOD_ErrorString = "An Event failed to be retrieved, most likely due to 'just fail' being specified as the max playbacks behaviour."
