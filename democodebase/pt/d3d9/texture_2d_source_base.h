#pragma once
#ifndef PT_D3D9_TEXTURE_2D_SOURCE_BASE_H
#define PT_D3D9_TEXTURE_2D_SOURCE_BASE_H
...
class texture_2d_source_base :
    public animatable_value_source<std::shared_ptr<texture_2d> >
{
