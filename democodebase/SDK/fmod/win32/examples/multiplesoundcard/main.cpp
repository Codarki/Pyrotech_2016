...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    for (count=0; count < numdrivers; count++)
    {
        ...
        result = systemA->getDriverName(count, name, 256);
        ERRCHECK(result);
    ...
    result = systemA->init(32, FMOD_INIT_NORMAL, 0);
    ERRCHECK(result);
    ...
    */
    ...
    for (count=0; count < numdrivers; count++)
    {
        ...
        result = systemB->getDriverName(count, name, 256);
        ERRCHECK(result);
    ...
    result = systemB->init(32, FMOD_INIT_NORMAL, 0);
    ERRCHECK(result);
