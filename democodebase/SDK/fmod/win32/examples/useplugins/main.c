...
int main(int argc, char *argv[])
{
    ...
    */
    {
        ...
        {
            result = FMOD_System_GetPluginInfo(system, FMOD_PLUGINTYPE_CODEC, count, name, 256, 0);
            ERRCHECK(result);
        ...
        for (count = 0; count < num; count++)
        {
            result = FMOD_System_GetPluginInfo(system, FMOD_PLUGINTYPE_DSP, count, name, 256, 0);
            ERRCHECK(result);
        ...
        for (count = 0; count < num; count++)
        {
            result = FMOD_System_GetPluginInfo(system, FMOD_PLUGINTYPE_OUTPUT, count, name, 256, 0);
            ERRCHECK(result);
    ...
    */
    ...
    result = FMOD_System_SetOutputByPlugin(system, key - '1');
    ERRCHECK(result);
