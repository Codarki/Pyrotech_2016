...
void init(void)
{
    ...
    printf("==================================================================\n");
    printf("Geometry example.  Copyright (c) Firelight Technologies 2004-2005.\n");
    printf("==================================================================\n\n");
    ...
    */
    ...
    result = fmodSystem->init(100, FMOD_INIT_NORMAL | FMOD_INIT_3D_RIGHTHANDED | FMOD_INIT_OCCLUSION_LOWPASS, 0);
    ERRCHECK(result);
